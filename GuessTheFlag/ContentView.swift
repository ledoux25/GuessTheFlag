        ...
        NavigationStack {
            ...
            ZStack {
                ...
                VStack {
                    ...
                    Text(numberSelected == nil ? "_________" : countries[correctAnswer])
                        .font(.title.bold())
                    Spacer()
                    Spacer()
                        ...
                        ForEach(0..<3, id: \.self) { number in
                            Button{
                                ...
                                ZStack(alignment: .leading) {
                                    Color.white
                                    if  number == numberSelected && number != correctAnswer  {
                                        Color(red:0.9,green:0.1,blue:0.2)
                                        
                                    }
                                    if  numberSelected != nil && number == correctAnswer{
                                         Color(red:0.3,green:0.7,blue:0.4)
                                    }
                                        Text("\(number + 1). \(countries[number])")
                                            .foregroundStyle(numberSelected == number || number == correctAnswer && numberSelected != nil  ? Color.white : Color.black)
                                            .font(.body.bold())
                    ...
                    HStack{
                        ForEach(answer, id: \.self) { ans in
                            Text("")
                                ...
                                .background(ans.contains("true") ? Color(red:0.3,green:0.7,blue:0.4) : Color(red:0.9,green:0.1,blue:0.2))
                    ...
                    HStack(spacing: 150) {
                        ...
                        }.alert("GAME OVER : \(score)/8", isPresented: $showingAlert, ){
